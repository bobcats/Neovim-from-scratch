...
local function setup_commands_ts(client, bufnr)
...
local function lsp_keymaps(bufnr)
  ...
  keymap(bufnr, "n", "<leader>ls", "<cmd>DocumentSymbols<CR>", opts)
  keymap(bufnr, "n", "<leader>lS", "<cmd>WorkspaceSymbols<CR>", opts)
...
M.on_attach = function(client, bufnr)
  ...
  if client.name == "rust_analyzer" then
    vim.api.nvim_buf_set_keymap(bufnr, "n", "gK", ":RustHoverActions<CR>", { noremap = true, silent = true })
  end
  ...
  if client.name == "ts_ls" then
    setup_commands_ts(client, bufnr)
  end
end
